...
Извлекай следующие поля и возвращай в формате JSON:
{
  ...
  "liquidationDate": "дата ликвидации (если есть)",
  ...
  "unreliableDate": "дата недостоверных сведений (если есть)",
  "riskInfo": "информация о рисках"
}

Если поле не найдено, используй null. Статус определяй по наличию фраз о ликвидации, банкротстве, фактах требующих внимания.`,
        messages: [
          {
            role: "user",
