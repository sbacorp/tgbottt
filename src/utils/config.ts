...
🟠 Оранжевый — есть риски, но организация пока не заблокирована
🟢 Зелёный — всё чисто, рисков нет.

Если организация попала в 🔴красный или 🟠 оранжевый списки вы получите оповещение в виде сообщения. Если организация находится в 🟢 Зелёном списке - все супер, вы оповещение не получаете.
...
export const STATUS_NAMES = {
  ...
  [ORGANIZATION_STATUS.ORANGE]: 'Оранжевый список',
